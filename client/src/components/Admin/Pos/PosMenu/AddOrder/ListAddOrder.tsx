...
function ListAddOrder({ orderItems }: Props) {
      ...
      {!open ? (
        ...
        >
          <div className="flex items-center justify-between bg-green-500 px-5 py-4">
            <h3 className="text-lg font-semibold text-white">รายการที่เลือก</h3>
            <button
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      ...
                      <input
                        ...
                        className="mt-2 w-full rounded-md border border-gray-200 px-2 py-1 text-sm text-gray-700 placeholder:text-gray-400"
                    ...
                    <button
                      ...
                      className="absolute top-11 right-2 text-red-500 hover:text-red-700"
          ...
          {editableItems.length > 0 && (
            <div className="sticky bottom-0 bg-white px-5 py-4">
              ...
              <button
                ...
                className="w-full rounded-xl bg-green-600 py-2 font-semibold text-white shadow-md hover:bg-green-700"
              >
                ยืนยันออเดอร์
              </button>
            </div>
