    ...
    <div className="fixed inset-0 z-50 flex min-h-screen flex-col justify-between bg-gray-50">
      ...
      <div className="space-y-3 bg-white px-6 py-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-green-500 p-4 font-semibold text-white transition hover:cursor-pointer hover:bg-green-600 active:scale-95"
        >
          <CheckCircle size={20} />
          ชำระเงิน / เช็คบิล
        </button>
