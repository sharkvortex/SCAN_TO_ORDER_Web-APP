...
function CallEmployee() {
  ...
  const [onConfirmCall, setOnConfirmCall] = useState<boolean>(false);
    ...
    <>
      {onConfirmCall && (
        <ConfirmDialog
          type="warn"
          title="เรียกพนักงาน"
          description="ต้องการเรียกพนักงานใช่หรือไม่?"
          cancelText="ยกเลิก"
          confirmText="ยืนยัน"
          onCancel={() => setOnConfirmCall(false)}
